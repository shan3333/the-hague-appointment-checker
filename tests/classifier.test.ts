...
const base: DomSignals = { pageHeadingPresent: true, calendarPresent: true, loadingVisible: false, noAppointmentsText: "", enabledDateCount: 0, availableTimeCount: 0, errorText: "" };
